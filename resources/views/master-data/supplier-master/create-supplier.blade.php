                ...
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto mt-5">
                        ...
                        <form action="{{ route('supplier-store')}}" method="POST" class="space-y-4">
                            ...
                            <button type="submit"
                                class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-black-600 border rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 john">Submit</button>
                        </form>
                    </div>
